...
class Log(object):
    ...
    def __init__(self, odir, task_name):
        ...
        self.func = [self.miner_error, self.empty, self.parse_error, self.success, self.oss]
        ...
        self.oss_log = self.full_path(odir, 'oss_ex', task_name)
    ...
    def oss(self, fname, info):
        with open(self.oss_log, 'a') as f:
            f.write('{0}\t{1}\t{2}\n'.format(fname, info, self.t()))
